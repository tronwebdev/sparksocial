...
export interface ToolIO {
  ...
  "calendar.get": {
    input: { campaignId: string };
    output: { campaignId: string; name: string; objective: "leads" | "bookings" | "trials" | "sales" | "audience" | "hiring"; status: "draft" | "active" | "paused"; mixActual: Array<{ pillar: string; count: number }>; slots: Array<{ id: string; scheduledAt: (string) | (null); pillar: (string) | (null); playbookId: (string) | (null); playbookName: (string) | (null); mode: (string) | (null); status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; platform: ("instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky") | (null); mediaType: (string) | (null) }> };
  };
