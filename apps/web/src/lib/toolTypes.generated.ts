...
export interface ToolIO {
  ...
  "calendar.get": {
    input: { campaignId: string };
    output: { campaignId: string; name: string; objective: "leads" | "bookings" | "trials" | "sales" | "audience" | "hiring"; status: "draft" | "active" | "paused"; mixActual: Array<{ pillar: "educational" | "product" | "proof" | "personality" | "community"; count: number }>; slots: Array<{ id: string; scheduledAt: (string) | (null); pillar: ("educational" | "product" | "proof" | "personality" | "community") | (null); playbookId: (string) | (null); playbookName: (string) | (null); mode: ("synthesize" | "assemble" | "direct_finish") | (null); status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; platform: ("instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky") | (null); mediaType: (string) | (null) }> };
  };
  ...
  "calendar.recommend_slot": {
    ...
    output: { date: string; create?: { playbookId: string; playbookName: string; description: string; mediaType: string; mode: "synthesize" | "assemble" | "direct_finish"; platforms: Array<"instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky">; pillar: "educational" | "product" | "proof" | "personality" | "community"; goal: string; cta?: string; designedTo: Array<string>; readiness: "ready" | "needs_upload" | "needs_capture"; missingRoles: Array<string>; alternativesLeft: number; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } }; move?: { contentItemId: string; playbookName: string; pillar: ("educational" | "product" | "proof" | "personality" | "community") | (null); currentlyAt: string; platform?: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; alternativesLeft: number; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } }; note?: string };
  };
  "campaign.create": {
  ...
  "content.get": {
    ...
    output: { contentItemId: string; playbookId: string; playbookMissing: boolean; mode: "synthesize" | "assemble" | "direct_finish"; mediaType: "video" | "image" | "carousel" | "text"; status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; campaignId?: string; beats: Array<({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "asset"; assetId: string; role: "talent_likeness" | "product_screen" | "work_artifact" | "physical_capture" | "product_shot" | "social_proof" | "knowledge" | "past_post" | "brand_kit"; caption: (string) | (null) }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "text"; text: string }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "generated_image"; url: string; prompt: string }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "generated_video"; url: string; script: string }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "generated_broll"; url: string; prompt: string }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "dubbed_media"; url: string; targetLanguage: string; mediaType: "video" | "audio" }) | ({ beatId: string; durationSec?: number; label?: string; voice?: "brand" | "stock"; lowerThird?: string; kind: "generated_audio"; url: string; script: string })>; durationBand?: [number, number]; why?: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> }; platform?: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; externalId?: string; via?: string; url?: string; blockedReason?: string; publishAttempts: number; lastPublishError?: string; variantGroupId?: string; variantLabel?: string };
  };
  "content.list": {
    input: { genomeId: string; status?: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; limit?: number };
    output: { items: Array<{ contentItemId: string; playbookId: string; playbookName: string; mediaType?: "video" | "image" | "carousel" | "text"; platform?: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; summary: string; scheduledAt?: string; createdAt: string; variantGroupId?: string; variantLabel?: string; blockedReason?: string; publishAttempts?: number }> };
  };
  ...
  "content.schedule": {
    ...
    output: { contentItemId: string; status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; scheduledAt: string };
  };
  "content.variant.result": {
    input: { genomeId: string; variantGroupId: string };
    output: { variantGroupId: string; arms: Array<{ contentItemId: string; label: string; status: "draft" | "needs_review" | "approved" | "scheduled" | "published" | "blocked" | "rolled_back"; impressions: number; engagements: number; engagementRate: (number) | (null) }>; winner: (string) | (null); undecidedBecause: ("awaiting_publish" | "awaiting_metrics" | "too_close") | (null); winnerContentItemId: (string) | (null); why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } };
  };
  ...
  "integration.health": {
    input: Record<string, never>;
    output: { platforms: Array<{ platform: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; connected: boolean; status: "not_connected" | "ok" | "expiring" | "expired"; accountLabel?: string; accountAvatarUrl?: string; expiresAt?: string; hoursUntilExpiry: (number) | (null); supported: boolean; connectedVia?: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; connectMethod: "oauth" | "credentials" | "derived"; via: (string) | (null) }>; needsAttention: Array<{ platform: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; status: "not_connected" | "ok" | "expiring" | "expired"; detail: string }> };
  };
  ...
  "learning.confidence": {
    input: { genomeId: string };
    output: { confidence: number; active: boolean; mixWeightsOverride: (Record<string, number>) | (null); arms: Array<{ pillar: "educational" | "product" | "proof" | "personality" | "community"; alpha: number; beta: number; observations: number; posteriorMean: number; qualifies: boolean }> };
  };
  "learning.explain": {
    input: { genomeId: string };
  ...
  "learning.record_outcome": {
    input: { genomeId: string; contentItemId: string };
    output: { recorded: boolean; pillar: "educational" | "product" | "proof" | "personality" | "community"; reward: number; arm: { pillar: "educational" | "product" | "proof" | "personality" | "community"; alpha: number; beta: number; observations: number; posteriorMean: number; qualifies: boolean }; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } };
  };
  "learning.reset": {
    input: { genomeId: string };
  ...
  "learning.reweight": {
    input: { genomeId: string };
    output: { confidence: number; mixWeightsOverride: (Record<string, number>) | (null); arms: Array<{ pillar: "educational" | "product" | "proof" | "personality" | "community"; alpha: number; beta: number; observations: number; posteriorMean: number; qualifies: boolean }>; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } };
  };
  "link.shorten": {
  ...
  "publish.now": {
    input: { contentItemId: string; genomeId: string; playbookId: string; platform: "instagram" | "instagram_story" | "tiktok" | "linkedin" | "x" | "youtube_shorts" | "youtube_long" | "facebook" | "facebook_group" | "threads" | "pinterest" | "google_business" | "reddit" | "bluesky"; text: string; referencedAssetIds?: Array<string>; mediaUrls?: Array<string>; target?: string };
  ...
  "trend.repurpose": {
    input: { genomeId: string; trendId: string };
    output: { suggestion: ({ playbookId: string; playbookName: string; pillar: "educational" | "product" | "proof" | "personality" | "community"; mode: "synthesize" | "assemble" | "direct_finish"; intent: string; unlockable: boolean; missingRoles: Array<string>; matchedOn: Array<string> }) | (null); why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } };
  };
  "trend.reshare": {
