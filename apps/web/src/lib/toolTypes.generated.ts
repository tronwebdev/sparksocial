...
export interface ToolIO {
  ...
  "analytics.post_metrics": {
    input: { genomeId: string; contentItemId: string };
    output: { contentItemId: string; synced: boolean; platforms: Array<{ platform: string; likes: number; comments: number; shares: number; views: number; impressions: number; saves: number; syncedAt: string }>; totals: { likes: number; comments: number; shares: number; views: number; impressions: number; saves: number } };
  };
  ...
  "analytics.sync": {
    input: { genomeId: string; contentItemId: string };
    output: { contentItemId: string; platform: string; likes: number; comments: number; shares: number; views: number; impressions: number; saves: number; syncedAt: string };
  };
  "approval.decide": {
  ...
  "calendar.get": {
    input: { campaignId: string };
    output: { campaignId: string; name: string; objective: string; status: string; mixActual: Array<{ pillar: string; count: number }>; slots: Array<{ id: string; scheduledAt: (string) | (null); pillar: (string) | (null); playbookId: (string) | (null); playbookName: (string) | (null); mode: (string) | (null); status: string; platform: (string) | (null); mediaType: (string) | (null) }> };
  };
  ...
  "calendar.recommend_slot": {
    ...
    output: { date: string; create?: { playbookId: string; playbookName: string; description: string; mediaType: string; mode: string; platforms: Array<string>; pillar: string; goal: string; cta?: string; designedTo: Array<string>; readiness: "ready" | "needs_upload" | "needs_capture"; missingRoles: Array<string>; alternativesLeft: number; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } }; move?: { contentItemId: string; playbookName: string; pillar: string; currentlyAt: string; platform?: string; alternativesLeft: number; why: { summary: string; factors: Array<{ label: string; weight?: number; detail?: string }>; evidence: Array<{ kind: "asset" | "knowledge_chunk" | "past_post" | "metric" | "rule" | "trend"; id: string; note?: string }>; alternatives: Array<{ option: string; rejectedBecause: string }> } }; note?: string };
  };
  "campaign.create": {
    input: { genomeId: string; name: string; objective: "leads" | "bookings" | "trials" | "sales" | "audience" | "hiring"; windowDays?: number; startAt?: string; targetCount?: number; targetLabel?: string; platforms?: Array<string>; approvalMode?: "autopublish" | "review_first_week" | "review_everything"; campaignType?: "promotion" | "lead_magnet" | "authority" | "launch"; primaryCta?: string; weight?: "dominant" | "balanced" | "light"; engagementRung?: "observe" | "suggest" | "auto_reply" | "sales_assist"; learnFromPerformance?: boolean; adjustMixAutomatically?: boolean };
  ...
  "playbook.get": {
    ...
    output: { playbookId: string; name: string; description: string; mode: "synthesize" | "assemble" | "direct_finish"; contentPillar: "educational" | "product" | "proof" | "personality" | "community"; mediaType: "video" | "image" | "carousel" | "text"; platforms: Array<string>; saturationRisk: "low" | "medium" | "high"; isActive: boolean; requiresDisclosure: boolean; complianceFlags: Array<string>; aspectRatios: Array<string>; beatCount: number; preconditions: { captureCapabilityAny?: Array<string>; proofAssetAny?: Array<string>; requiredAssetRoles: Array<string>; minAssets: number; talentRequired: boolean; requiresLikenessLicense: boolean } };
  };
  "playbook.list": {
    input: { activeOnly?: boolean };
    output: { playbooks: Array<{ playbookId: string; name: string; description: string; mode: "synthesize" | "assemble" | "direct_finish"; contentPillar: "educational" | "product" | "proof" | "personality" | "community"; mediaType: "video" | "image" | "carousel" | "text"; platforms: Array<string>; saturationRisk: "low" | "medium" | "high" }>; total: number };
  };
  "playbook.resolve": {
