// figma node: 1044:8528 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings14(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        height: 943,
        borderRadius: 20,
        background: "linear-gradient(180deg, rgb(108,232,255) 0.00%, rgba(255,255,255,0) 60.18%), linear-gradient(rgb(255,255,255),rgb(255,255,255))",
      }} />
      <div style={{
        position: "absolute",
        left: 701,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width={22.067} height={22.067} viewBox="0 0 22.067 22.067" fill="none" style={{
                position: "absolute",
                left: 0,
                top: 0,
                width: 22.067,
                ...
                <path d={"M 12.612 0.592 C 12.168 0.21 11.602 0 11.016 0 C 10.43 0 9.864 0.21 9.42 0.592 C 9.098 0.869 8.778 1.148 8.46 1.429 C 8.045 1.346 7.629 1.263 7.21 1.184 C 6.634 1.075 6.039 1.177 5.531 1.47 C 5.024 1.763 4.639 2.228 4.445 2.781 C 4.303 3.187 4.164 3.592 4.031 3.993 C 3.62 4.13 3.21 4.271 2.797 4.416 C 2.245 4.609 1.78 4.995 1.487 5.502 C 1.195 6.009 1.093 6.604 1.202 7.18 C 1.282 7.603 1.363 8.022 1.448 8.438 C 1.162 8.762 0.877 9.088 0.592 9.42 C 0.21 9.864 0 10.43 0 11.016 C 0 11.602 0.21 12.168 0.592 12.612 C 0.879 12.947 1.166 13.275 1.454 13.6 C 1.367 14.028 1.283 14.457 1.202 14.887 C 1.093 15.462 1.195 16.057 1.487 16.565 C 1.78 17.072 2.245 17.457 2.797 17.651 C 3.21 17.795 3.62 17.936 4.029 18.074 C 4.165 18.477 4.303 18.88 4.444 19.286 C 4.845 20.43 6.019 21.106 7.21 20.883 C 7.639 20.801 8.065 20.717 8.488 20.632 C 8.806 20.914 9.128 21.194 9.455 21.475 C 9.899 21.857 10.465 22.067 11.051 22.067 C 11.636 22.067 12.203 21.857 12.647 21.475 L 12.106 20.846 L 12.647 21.476 C 12.969 21.199 13.29 20.919 13.608 20.637 C 14.021 20.722 14.437 20.803 14.857 20.883 C 15.433 20.991 16.028 20.89 16.535 20.597 C 17.042 20.304 17.428 19.839 17.621 19.286 C 17.764 18.88 17.903 18.477 18.036 18.074 C 18.447 17.936 18.856 17.795 19.269 17.651 C 19.822 17.457 20.287 17.072 20.579 16.565 C 20.872 16.057 20.973 15.462 20.864 14.887 C 20.786 14.467 20.704 14.047 20.619 13.628 C 20.904 13.305 21.191 12.978 21.475 12.647 C 21.857 12.203 22.067 11.636 22.067 11.051 C 22.067 10.465 21.857 9.899 21.475 9.455 C 21.19 9.123 20.902 8.794 20.612 8.466 C 20.7 8.038 20.784 7.609 20.864 7.18 C 20.973 6.604 20.872 6.009 20.579 5.502 C 20.287 4.995 19.822 4.609 19.269 4.416 C 18.86 4.272 18.449 4.131 18.037 3.993 C 17.902 3.588 17.764 3.184 17.623 2.781 C 17.429 2.227 17.044 1.762 16.536 1.469 C 16.029 1.176 15.433 1.075 14.857 1.184 C 14.427 1.265 14.001 1.35 13.58 1.434 C 13.259 1.151 12.937 0.87 12.612 0.592 Z"} fill="currentColor" fillRule="evenodd" />
              </svg>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <svg width={7.422} height={1.320} viewBox="0 -0.660 7.422 1.320" fill="none" style={{
                  position: "absolute",
                  left: 7.421,
                  top: 14.122,
                  width: 7.422,
                  height: 1.3195102214813232,
                  color: "rgb(12,12,12)",
                }}>
                  <path d={"M 0 -0.66 C -0.364 -0.66 -0.66 -0.364 -0.66 0 C -0.66 0.364 -0.364 0.66 0 0.66 L 0 0 L 0 -0.66 Z M 7.422 0.66 C 7.787 0.66 8.082 0.364 8.082 0 C 8.082 -0.364 7.787 -0.66 7.422 -0.66 L 7.422 0 L 7.422 0.66 Z M 0 0 L 0 0.66 L 7.422 0.66 L 7.422 0 L 7.422 -0.66 L 0 -0.66 L 0 0 Z"} fill="currentColor" fillRule="nonzero" />
                </svg>
                <svg width={14.120} height={14.120} viewBox="0 0 14.120 14.120" fill="none" style={{
                  position: "absolute",
                  left: 0,
                  top: -0.001,
                  width: 14.12,
                  ...
                  <path d={"M 11.133 0.512 L 11.6 0.979 L 11.6 0.979 L 11.133 0.512 Z M 13.607 2.986 L 14.074 3.453 L 14.074 3.453 L 13.607 2.986 Z M 3.299 13.295 L 3.459 13.935 C 3.575 13.906 3.681 13.846 3.765 13.762 L 3.299 13.295 Z M 0 14.12 L -0.64 13.96 C -0.696 14.185 -0.63 14.422 -0.467 14.586 C -0.303 14.75 -0.065 14.816 0.16 14.76 L 0 14.12 Z M 0.825 10.821 L 0.358 10.355 C 0.274 10.439 0.214 10.545 0.185 10.661 L 0.825 10.821 Z M 11.133 0.512 L 11.6 0.979 C 11.804 0.775 12.081 0.66 12.37 0.66 L 12.37 0 L 12.37 -0.66 C 11.731 -0.66 11.119 -0.406 10.667 0.046 L 11.133 0.512 Z M 12.37 0 L 12.37 0.66 C 12.659 0.66 12.937 0.775 13.141 0.979 L 13.607 0.512 L 14.074 0.046 C 13.622 -0.406 13.009 -0.66 12.37 -0.66 L 12.37 0 Z M 13.607 0.512 L 13.141 0.979 C 13.345 1.183 13.46 1.46 13.46 1.749 L 14.12 1.749 L 14.78 1.749 C 14.78 1.11 14.526 0.498 14.074 0.046 L 13.607 0.512 Z M 14.12 1.749 L 13.46 1.749 C 13.46 2.038 13.345 2.316 13.141 2.52 L 13.607 2.986 L 14.074 3.453 C 14.526 3.001 14.78 2.388 14.78 1.749 L 14.12 1.749 Z M 13.607 2.986 L 13.141 2.52 L 2.832 12.829 L 3.299 13.295 L 3.765 13.762 L 14.074 3.453 L 13.607 2.986 Z M 3.299 13.295 L 3.139 12.655 L -0.16 13.48 L 0 14.12 L 0.16 14.76 L 3.459 13.935 L 3.299 13.295 Z M 0 14.12 L 0.64 14.28 L 1.465 10.981 L 0.825 10.821 L 0.185 10.661 L -0.64 13.96 L 0 14.12 Z M 0.825 10.821 L 1.291 11.288 L 11.6 0.979 L 11.133 0.512 L 10.667 0.046 L 0.358 10.355 L 0.825 10.821 Z"} fill="currentColor" fillRule="nonzero" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <span style={{
            ...
            fontSize: 24,
            textAlign: "center",
            lineHeight: "99.88500213623047%",
            color: "rgb(12,12,12)",
          }}>Decide how your Agent listens, responds, and escalates conversations.</span>
          <span style={{
            position: "absolute",
            left: 0,
            top: 455,
            ...
            color: "rgb(131,131,131)",
          }}>Your Agent can do more than post content. It can monitor comments and DMs, draft replies, or respond automatically, all within the boundaries you set.</span>
          <div style={{
            position: "absolute",
            left: 70.492,
            top: 0,
            ...
            <div style={{
              ...
              height: 278.664,
              borderRadius: "50%",
              backgroundColor: "rgba(108,232,255,0.12)",
              backdropFilter: "blur(60.252px)",
            }} />
            <div style={{
              position: "absolute",
              left: 0,
              top: 0,
              transform: "matrix(1,0,0,-1,73.039,259.306)",
              transformOrigin: "0 0",
              width: 196.275,
              height: 196.275,
              borderRadius: "50%",
              backgroundColor: "rgba(132,201,214,0.19)",
              backdropFilter: "blur(42.438px)",
            }} />
            <div style={{
              position: "absolute",
              left: 107.909,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  left: 0,
                  top: 0,
                  width: 127.0215835571289,
                  height: 127.0215835571289,
                  clipPath: "ellipse(63.511px 63.511px at 63.511px 63.511px)",
                }}>
                  <div style={{
                    position: "absolute",
                    left: 0,
                    ...
                    backdropFilter: "blur(41.930px)",
                    boxShadow: "inset 0px 0px 12.702px -2.540px rgb(233,239,245)",
                  }} />
                  <div style={{
                    position: "absolute",
                    left: 22.235,
                  ...
                  <div style={{
                    ...
                    width: 77.571,
                    height: 31.448,
                    borderRadius: 23.47123908996582,
                    backgroundColor: "rgba(255,255,255,0.07)",
                    backdropFilter: "blur(21.198px)",
                    boxShadow: "inset 0px 0px 11.813px -2.097px rgb(108,232,255)",
                  }} />
                </div>
              </div>
              <div style={{
                ...
                width: 12.702,
                height: 12.702,
                borderRadius: 25.40431022644043,
                backgroundColor: "rgb(255,255,255)",
              }} />
              <div style={{
                position: "absolute",
            ...
            <div className="fig-asset-85b0f7c9af238a5d-5e2541bc" style={{
              position: "absolute",
              left: 123.183,
              top: 237.816,
              width: 90.434,
            ...
            <div className="fig-asset-121fd61211fa2c97-cc0526ee" style={{
              position: "absolute",
              left: 0,
              top: 0,
              transform: "matrix(-1,0.005,0.005,1,81.272,114.209)",
              transformOrigin: "0 0",
              width: 81.273,
              height: 85.985,
            }} />
            <div className="fig-asset-c590a30b1bce695d-3cff76e1" style={{
              position: "absolute",
              left: 125.332,
              top: 0,
              width: 87.392,
            ...
            <div className="fig-asset-95573d5258a57c97-3dff1350" style={{
              position: "absolute",
              left: 0,
              top: 0,
              transform: "matrix(0.994,0.112,-0.112,0.994,255.344,101.122)",
              transformOrigin: "0 0",
              width: 90.298,
              height: 95.529,
            }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          left: 0,
          top: 0,
          transform: "matrix(-1,0,0,1,275,124)",
          transformOrigin: "0 0",
          width: 266,
          height: 50,
          borderRadius: 10,
...
export default AccountSettingsWorkspaceSettings14;
