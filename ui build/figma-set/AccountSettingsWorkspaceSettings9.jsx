// figma node: 1044:7520 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings9(_p = {}) {
  const props = _p;
  return (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width={617} height={669} viewBox="0 0 617 669" fill="none" style={{
                position: "absolute",
                left: 0,
                top: 0,
                width: 617,
                ...
                <path d={"M 0 30.003 C 0 13.434 13.432 0.003 30 0.003 L 277.699 0.003 L 309.636 0 L 340.679 0.003 L 587 0.003 C 603.568 0.003 617 13.434 617 30.003 L 617 639 C 617 655.569 603.569 669 587 669 L 30.105 669 C 13.496 669 0.047 655.505 0.105 638.895 L 1.171 334.33 L 0 244.81 L 0 129.541 L 0 30.003 Z"} fill="currentColor" fillRule="nonzero" />
              </svg>
              <svg width={617} height={1} viewBox="0 -0.500 617 1" fill="none" style={{
                position: "absolute",
                left: 0,
                top: 76,
                width: 617,
                ...
                <path d={"M 0 -0.5 C -0.276 -0.5 -0.5 -0.276 -0.5 0 C -0.5 0.276 -0.276 0.5 0 0.5 L 0 0 L 0 -0.5 Z M 617 0.5 C 617.276 0.5 617.5 0.276 617.5 0 C 617.5 -0.276 617.276 -0.5 617 -0.5 L 617 0 L 617 0.5 Z M 0 0 L 0 0.5 L 617 0.5 L 617 0 L 617 -0.5 L 0 -0.5 L 0 0 Z"} fill="currentColor" fillRule="nonzero" />
              </svg>
              <div style={{
                position: "absolute",
                left: 42,
                ...
                <svg width={13} height={13} viewBox="0 0 13 13" fill="none" style={{
                  ...
                  <path d={"M 1.596 0.261 C 1.421 0.092 1.187 -0.002 0.943 0 C 0.7 0.002 0.467 0.1 0.295 0.272 C 0.123 0.444 0.025 0.677 0.023 0.921 C 0.021 1.164 0.114 1.399 0.283 1.574 L 5.198 6.489 L 0.283 11.404 C 0.195 11.489 0.124 11.592 0.075 11.705 C 0.027 11.818 0.001 11.94 0 12.063 C -0.001 12.187 0.022 12.309 0.069 12.423 C 0.116 12.537 0.185 12.641 0.272 12.728 C 0.359 12.815 0.463 12.884 0.577 12.931 C 0.691 12.978 0.813 13.001 0.937 13 C 1.06 12.999 1.182 12.973 1.295 12.925 C 1.408 12.876 1.511 12.805 1.596 12.717 L 6.511 7.802 L 11.426 12.717 C 11.601 12.886 11.836 12.979 12.079 12.977 C 12.323 12.975 12.556 12.877 12.728 12.705 C 12.9 12.533 12.998 12.3 13 12.057 C 13.002 11.813 12.908 11.579 12.739 11.404 L 7.824 6.489 L 12.739 1.574 C 12.908 1.399 13.002 1.164 13 0.921 C 12.998 0.677 12.9 0.444 12.728 0.272 C 12.556 0.1 12.323 0.002 12.079 0 C 11.836 -0.002 11.601 0.092 11.426 0.261 L 6.511 5.176 L 1.596 0.261 Z"} fill="currentColor" fillRule="evenodd" />
                </svg>
                <span style={{
                  position: "absolute",
                  left: 60,
                ...
                <div className="fig-asset-692bc62a59a1c5d2" style={{
                  ...
                  width: 39.637,
                  height: 39.637,
                  borderRadius: 75.46012115478516,
                }} />
              </div>
              <div style={{
                position: "absolute",
                ...
                <div style={{
                  ...
                  left: 0,
                  top: 0,
                  transform: "matrix(-1,0,0,1,227,0)",
                  transformOrigin: "0 0",
                  width: 227,
                  height: 49,
                  borderRadius: 1000,
                ...
                <div className="fig-asset-ebd4a3a11f0187a9" style={{
                  ...
                  width: 40,
                  height: 40,
                  borderRadius: 76.15081787109375,
                }} />
              </div>
              <div style={{
                position: "absolute",
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <svg width={6.133} height={12.265} viewBox="0 0 6.133 12.265" fill="none" style={{
                    ...
                    left: 0,
                    top: 0,
                    transform: "matrix(0,1,-1,0,496.265,16.367)",
                    transformOrigin: "0 0",
                    width: 6.133,
                    height: 12.265,
                  ...
                  <div className="fig-asset-883a3578d2137445" style={{
                    position: "absolute",
                    left: 0,
                    top: 0,
                    width: 39.325,
                    height: 39.325,
                    borderRadius: 74.8663101196289,
                  }} />
                </div>
                <span style={{
                  position: "absolute",
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    width: 109,
                    height: 33.306,
                    borderRadius: 6.208282947540283,
                    backgroundColor: "rgba(131,131,131,0.1)",
                  }} />
                  <span style={{
                    position: "absolute",
                ...
                <div style={{
                  ...
                  <svg width={6.133} height={12.265} viewBox="0 0 6.133 12.265" fill="none" style={{
                    ...
                    left: 0,
                    top: 0,
                    transform: "matrix(0,1,-1,0,482.265,10.367)",
                    transformOrigin: "0 0",
                    width: 6.133,
                    height: 12.265,
                    borderRadius: 0.6455477476119995,
...
export default AccountSettingsWorkspaceSettings9;
