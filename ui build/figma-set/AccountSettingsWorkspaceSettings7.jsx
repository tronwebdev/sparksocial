// figma node: 1044:7267 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings7(_p = {}) {
  const props = _p;
  return (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width={799} height={810} viewBox="0 0 799 810" fill="none" style={{
                position: "absolute",
                left: 0,
                top: 0,
                width: 799,
                ...
                <path d={"M 0 30.004 C 0 13.435 13.432 0.004 30 0.004 L 359.613 0.003 L 400.971 0 L 441.171 0.003 L 769 0.003 C 785.568 0.003 799 13.435 799 30.003 L 799 780 C 799 796.569 785.569 810 769 810 L 30.113 810 C 13.5 810 0.051 796.5 0.113 779.888 L 1.516 404.794 L 0 296.407 L 0 156.843 L 0 30.004 Z"} fill="currentColor" fillRule="nonzero" />
              </svg>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    backgroundColor: "rgba(38,84,235,0.1)",
                  }} />
                  ...
                  <svg width={16} height={16} viewBox="0 0 16 16" fill="none" style={{
                    ...
                    width: 16,
                    height: 16,
                    borderRadius: 0.888888955116272,
                    color: "rgb(38,84,235)",
                  }}>
                    <path d={"M 7.166 2.253 C 7.453 1.479 8.547 1.479 8.834 2.253 L 10.019 5.456 C 10.109 5.699 10.301 5.891 10.544 5.981 L 13.747 7.166 C 14.521 7.453 14.521 8.547 13.747 8.834 L 10.544 10.019 C 10.301 10.109 10.109 10.301 10.019 10.544 L 8.834 13.747 C 8.547 14.521 7.453 14.521 7.166 13.747 L 5.981 10.544 C 5.891 10.301 5.699 10.109 5.456 10.019 L 2.253 8.834 C 1.479 8.547 1.479 7.453 2.253 7.166 L 5.456 5.981 C 5.699 5.891 5.891 5.699 5.981 5.456 L 7.166 2.253 Z"} fill="currentColor" fillRule="nonzero" />
                  </svg>
                </div>
                <span style={{
                  position: "absolute",
...
export default AccountSettingsWorkspaceSettings7;
