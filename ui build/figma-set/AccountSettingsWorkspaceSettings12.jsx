// figma node: 1044:8190 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings12(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 1385,
          borderRadius: 30,
          background: "linear-gradient(157.719deg, rgba(245,107,255,0.2) 2.55%, rgba(255,255,255,0) 71.13%), linear-gradient(203.866deg, rgba(108,232,255,0.3) 2.24%, rgba(255,255,255,0) 75.43%), linear-gradient(rgb(247,247,247),rgb(247,247,247))",
        }} />
        <span style={{
          position: "absolute",
          left: 138,
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 232,
          borderRadius: 13.364087104797363,
          background: "linear-gradient(180deg, rgb(149,238,255) 0.00%, rgb(208,158,255) 42.51%, rgb(255,255,255) 100.00%), linear-gradient(rgb(255,255,255),rgb(255,255,255))",
        }} />
        <div style={{
          position: "absolute",
          left: 10,
          ...
          width: 379,
          height: 121,
          borderRadius: 10.143824577331543,
          backgroundColor: "rgb(255,255,255)",
        }} />
        <div style={{
          position: "absolute",
          ...
          <div style={{
            ...
            <div style={{
              ...
              width: 208,
              height: 34,
              borderRadius: 44.72675704956055,
              backgroundColor: "rgba(255,255,255,0.16)",
              boxShadow: "inset 0 0 0 0.493px rgb(131,131,131)",
            }} />
            <span style={{
              position: "absolute",
              left: 14,
              ...
              fontFamily: "Onest, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
              fontWeight: 500,
              fontSize: 13.481480598449707,
              whiteSpace: "nowrap",
              lineHeight: "100%",
              color: "rgb(12,12,12)",
            }}>Read the migration guide</span>
            <svg width={10.856} height={14.475} viewBox="0 0 10.856 14.475" fill="none" style={{
              position: "absolute",
              left: 0,
              top: 0,
              transform: "matrix(0.682,0.731,-0.731,0.682,186.584,8)",
              transformOrigin: "0 0",
              width: 10.856,
              height: 14.475,
              color: "rgb(12,12,12)",
            }}>
              <path d={"M 1.546 6.068 L 4.524 3.089 L 4.524 13.569 C 4.524 14.266 5.278 14.701 5.881 14.353 C 6.161 14.191 6.333 13.892 6.333 13.569 L 6.333 3.089 L 9.311 6.068 C 9.804 6.561 10.645 6.335 10.826 5.662 C 10.909 5.35 10.82 5.017 10.591 4.788 L 6.068 0.265 C 5.715 -0.088 5.142 -0.088 4.789 0.265 L 0.266 4.788 C -0.227 5.281 -0.002 6.122 0.671 6.302 C 0.984 6.386 1.317 6.297 1.546 6.068 Z"} fill="currentColor" fillRule="nonzero" />
            </svg>
          </div>
        </div>
        <span style={{
        ...
        <span style={{
          ...
          lineHeight: "100%",
          color: "rgb(12,12,12)",
        }}>Need to migrate to a fresh environment?</span>
        <span style={{
          position: "absolute",
          left: 21,
          top: 93,
          ...
          lineHeight: "100%",
          color: "rgb(131,131,131)",
        }}>Export from the source, then import into the destination. Everything stays consistent — including IDs and references.</span>
      </div>
      <div style={{
        position: "absolute",
        left: 392,
        ...
        <div style={{
          ...
          borderRadius: 15,
          backgroundColor: "rgb(255,255,255)",
          outline: "1.500px dashed rgba(12,12,12,0.2)",
          outlineOffset: "-1.500px",
        }} />
        <div style={{
          position: "absolute",
          left: 314,
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: 103,
            borderRadius: "50%",
            backgroundColor: "rgba(108,232,255,0.28)",
            backdropFilter: "blur(49.414px)",
          }} />
          <div className="fig-asset-35ba7ab4a793af7c-2bf140d3" style={{
            position: "absolute",
            left: 0,
            top: 2.785,
            width: 132,
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: "rgb(12,12,12)",
        }}>Import from another workspace</span>
        <span style={{
          position: "absolute",
          left: 1,
          top: 32,
      ...
      <div style={{
        ...
        <div style={{
          ...
          left: 0,
          top: 0,
          transform: "matrix(-1,0,0,1,221,4)",
          transformOrigin: "0 0",
          width: 107,
          height: 42,
          borderRadius: 9.424633979797363,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            fontFamily: "Onest, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
            fontWeight: 500,
            fontSize: 15.190042495727539,
            whiteSpace: "nowrap",
            lineHeight: "100%",
            color: "rgb(255,255,255)",
          }}>Start Import</span>
          <svg width={13.775} height={16.280} viewBox="0 0 13.775 16.280" fill="none" style={{
            position: "absolute",
            left: 0,
            top: 0,
            transform: "matrix(1,0,0,-1,18.662,30.441)",
            transformOrigin: "0 0",
            width: 13.775,
            height: 16.28,
            color: "rgb(255,255,255)",
          }}>
            <path d={"M 13.775 7.514 L 13.775 15.028 C 13.775 15.72 13.214 16.28 12.523 16.28 L 1.252 16.28 C 0.561 16.28 0 15.72 0 15.028 L 0 7.514 C 0 6.823 0.561 6.262 1.252 6.262 L 3.131 6.262 C 3.613 6.262 3.914 6.784 3.673 7.201 C 3.561 7.395 3.354 7.514 3.131 7.514 L 1.252 7.514 L 1.252 15.028 L 12.523 15.028 L 12.523 7.514 L 10.644 7.514 C 10.162 7.514 9.861 6.992 10.102 6.575 C 10.214 6.381 10.421 6.262 10.644 6.262 L 12.523 6.262 C 13.215 6.262 13.775 6.823 13.775 7.514 Z M 4.2 4.2 L 6.261 2.138 L 6.261 9.393 C 6.261 9.875 6.783 10.176 7.201 9.935 C 7.394 9.823 7.514 9.616 7.514 9.393 L 7.514 2.138 L 9.575 4.2 C 9.916 4.541 10.499 4.385 10.623 3.919 C 10.681 3.703 10.62 3.473 10.461 3.314 L 7.331 0.184 C 7.086 -0.061 6.689 -0.061 6.445 0.184 L 3.314 3.314 C 2.973 3.655 3.129 4.238 3.595 4.363 C 3.811 4.42 4.042 4.359 4.2 4.2 Z"} fill="currentColor" fillRule="nonzero" />
          </svg>
        </div>
        <span style={{
          position: "absolute",
          ...
          lineHeight: 1.809999942779541,
          color: "rgb(131,131,131)",
        }}>Merge with existing items (skip duplicates)</span>
        <div style={{
          position: "absolute",
          left: 24,
          top: 399,
          ...
          <svg width={7.309} height={7.313} viewBox="0 0 7.309 7.313" fill="none" style={{
            position: "absolute",
            left: 5.25,
            top: 5.25,
            width: 7.309,
            ...
            <path d={"M 7.067 0.306 C 7.149 0.397 7.213 0.503 7.254 0.618 C 7.295 0.734 7.314 0.856 7.308 0.979 C 7.302 1.101 7.272 1.221 7.219 1.332 C 7.167 1.443 7.093 1.542 7.002 1.624 C 6.159 2.389 5.588 3.02 5.118 3.753 C 4.643 4.494 4.245 5.38 3.79 6.687 C 3.737 6.837 3.647 6.972 3.528 7.077 C 3.409 7.183 3.265 7.257 3.11 7.291 C 2.954 7.325 2.793 7.319 2.64 7.273 C 2.488 7.227 2.35 7.143 2.239 7.029 L 0.258 4.987 C 0.088 4.809 -0.005 4.571 0 4.325 C 0.005 4.079 0.107 3.845 0.284 3.673 C 0.46 3.502 0.698 3.407 0.944 3.41 C 1.19 3.413 1.425 3.513 1.597 3.689 L 2.556 4.677 C 2.86 3.95 3.178 3.324 3.547 2.747 C 4.137 1.827 4.834 1.072 5.749 0.243 C 5.839 0.16 5.945 0.096 6.061 0.055 C 6.176 0.013 6.298 -0.005 6.421 0.001 C 6.543 0.007 6.663 0.037 6.774 0.089 C 6.885 0.142 6.984 0.215 7.067 0.306 Z"} fill="currentColor" fillRule="evenodd" />
          </svg>
        </div>
        <svg width={827} height={1} viewBox="0 -0.500 827 1" fill="none" style={{
          position: "absolute",
          left: 0,
          top: 94,
          width: 827,
          ...
          <path d={"M 0 -0.5 C -0.276 -0.5 -0.5 -0.276 -0.5 0 C -0.5 0.276 -0.276 0.5 0 0.5 L 0 0 L 0 -0.5 Z M 827 0.5 C 827.276 0.5 827.5 0.276 827.5 0 C 827.5 -0.276 827.276 -0.5 827 -0.5 L 827 0 L 827 0.5 Z M 0 0 L 0 0.5 L 827 0.5 L 827 0 L 827 -0.5 L 0 -0.5 L 0 0 Z"} fill="currentColor" fillRule="nonzero" />
        </svg>
        <svg width={827} height={1} viewBox="0 -0.500 827 1" fill="none" style={{
          position: "absolute",
          left: 0,
        ...
        <div style={{
          ...
          <span style={{
            ...
            lineHeight: 1.809999942779541,
            color: "rgb(131,131,131)",
          }}>24 members · updated 2h ago</span>
          <div style={{
            position: "absolute",
            left: 40,
            top: 0,
            ...
            <div style={{
              ...
              width: 52.527,
              height: 52.527,
              borderRadius: 12.322267532348633,
              backgroundColor: "rgb(245,107,255)",
            }} />
            <span style={{
              position: "absolute",
        ...
        <div style={{
          ...
          <span style={{
            ...
            lineHeight: 1.809999942779541,
            color: "rgb(131,131,131)",
          }}>12 members · updated Yesterday</span>
          <div style={{
            position: "absolute",
            left: 40,
            top: 0,
            ...
            <div style={{
              ...
              height: 52.527,
              borderRadius: 12.322267532348633,
              backgroundColor: "rgb(125,255,123)",
            }} />
            <span style={{
              position: "absolute",
              left: 19,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              height: 52.527,
              borderRadius: 12.322267532348633,
              backgroundColor: "rgb(248,144,113)",
            }} />
            <span style={{
              position: "absolute",
              left: 19,
        ...
        <div style={{
          ...
          <span style={{
            ...
            lineHeight: 1.809999942779541,
            color: "rgb(131,131,131)",
          }}>31 members · updated 1w ago</span>
          <div style={{
            position: "absolute",
            left: 40,
            top: 0,
            ...
            <div style={{
              ...
              height: 52.527,
              borderRadius: 12.322267532348633,
              backgroundColor: "rgb(170,173,255)",
            }} />
            <span style={{
              position: "absolute",
              left: 17,
...
export default AccountSettingsWorkspaceSettings12;
