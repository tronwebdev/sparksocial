// figma node: 1044:8791 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings16(_p = {}) {
  const props = _p;
  return (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <svg width={692} height={963} viewBox="0 0 692 963" fill="none" style={{
                  position: "absolute",
                  left: 0,
                  top: 0,
                  width: 692,
                  ...
                  <path d={"M 0 41.981 C 0 18.798 18.794 0.004 41.977 0.004 L 311.454 0.004 L 347.274 0 L 382.091 0.004 L 650.023 0.004 C 673.206 0.004 692 18.798 692 41.981 L 692 921.023 C 692 944.206 673.206 963 650.023 963 L 42.092 963 C 18.864 963 0.052 944.136 0.115 920.908 L 1.313 481.255 L 0 352.395 L 0 186.469 L 0 41.981 Z"} fill="currentColor" fillRule="nonzero" />
                </svg>
              </div>
            </div>
            <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                lineHeight: "100%",
                color: "rgb(131,131,131)",
              }}>Respond to activity from your connected Instagram account</span>
            </div>
            <div style={{
              position: "absolute",
              left: 49,
            ...
            <span style={{
              ...
              color: "rgb(131,131,131)",
            }}>Define the boundaries for how your agents will hand comments and direct messages</span>
          </div>
        </div>
      </div>
      <div style={{
...
export default AccountSettingsWorkspaceSettings16;
