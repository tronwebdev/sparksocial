// figma node: 1044:8656 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings15(_p = {}) {
  const props = _p;
  return (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: "linear-gradient(227.026deg, rgba(108,232,255,0.15) 9.05%, rgba(163,65,255,0.15) 92.05%)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                left: 0,
                top: 0,
                width: 692.2213745117188,
                height: 668,
                clipPath: "inset(0px 0px 0px 0.000px round 41.977px)",
              }}>
                <svg width={692} height={668} viewBox="0 0 692 668" fill="none" style={{
                  position: "absolute",
                  left: 0.002,
                  top: 0,
                  width: 692,
                  height: 668,
                  borderRadius: 41.977237701416016,
                  backdropFilter: "blur(57.794px)",
                  color: "rgb(255,255,255)",
                }}>
                  <path d={"M 0 41.98 C 0 18.797 18.794 0.003 41.977 0.003 L 311.454 0.003 L 347.274 0 L 382.091 0.003 L 650.023 0.003 C 673.206 0.003 692 18.796 692 41.98 L 692 626.023 C 692 649.206 673.206 668 650.023 668 L 42.143 668 C 18.895 668 0.074 649.106 0.166 625.858 L 1.313 333.83 L 0 244.444 L 0 129.347 L 0 41.98 Z"} fill="currentColor" fillRule="nonzero" />
                </svg>
              </div>
            </div>
            <div style={{
            ...
            <span style={{
              ...
              color: "rgb(0,0,0)",
            }}>Configure Engagement Intelligence</span>
            <div style={{
              position: "absolute",
              left: 52,
              top: 197,
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  width: 27,
                  height: 27,
                  borderRadius: 134.99998474121094,
                  backgroundColor: "rgba(131,131,131,0.1)",
                  boxShadow: "inset 0 0 0 0.844px rgba(131,131,131,0.2)",
                }} />
              </div>
              <span style={{
                position: "absolute",
              ...
              <span style={{
                ...
                lineHeight: "100%",
                color: "rgb(131,131,131)",
              }}>Draft replies for approval; escalate sensitive conversations</span>
            </div>
            <div style={{
              position: "absolute",
              left: 52.001,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  borderRadius: 134.99998474121094,
                  backgroundColor: "rgb(108,232,255)",
                  boxShadow: "inset 0 0 0 2px rgb(12,12,12)",
                }} />
                <svg width={12} height={12.007} viewBox="0 0 12 12.007" fill="none" style={{
                  position: "absolute",
                  left: 7,
                  top: 8.336,
                  width: 12,
                  ...
                  <path d={"M 11.603 0.502 C 11.738 0.651 11.842 0.826 11.91 1.015 C 11.978 1.205 12.008 1.406 11.998 1.607 C 11.988 1.808 11.939 2.005 11.853 2.187 C 11.767 2.369 11.646 2.532 11.496 2.667 C 10.112 3.922 9.175 4.958 8.403 6.162 C 7.623 7.379 6.97 8.833 6.222 10.979 C 6.136 11.226 5.989 11.447 5.793 11.62 C 5.598 11.794 5.361 11.914 5.106 11.971 C 4.851 12.027 4.585 12.017 4.335 11.942 C 4.085 11.866 3.858 11.728 3.676 11.541 L 0.424 8.188 C 0.145 7.896 -0.008 7.505 0 7.101 C 0.008 6.697 0.175 6.312 0.466 6.031 C 0.756 5.75 1.145 5.595 1.549 5.599 C 1.953 5.604 2.339 5.768 2.623 6.056 L 4.197 7.679 C 4.695 6.485 5.218 5.458 5.824 4.511 C 6.792 3 7.938 1.76 9.438 0.398 C 9.587 0.263 9.761 0.158 9.951 0.09 C 10.14 0.022 10.341 -0.008 10.542 0.002 C 10.743 0.011 10.94 0.061 11.122 0.147 C 11.304 0.232 11.467 0.353 11.603 0.502 Z"} fill="currentColor" fillRule="evenodd" />
                </svg>
              </div>
              <span style={{
                position: "absolute",
              ...
              <span style={{
                ...
                lineHeight: "100%",
                color: "rgb(131,131,131)",
              }}>Auto‑reply to FAQs; review leads and risky messages</span>
            </div>
            <div style={{
              position: "absolute",
              left: 52.001,
              ...
              <span style={{
                ...
                lineHeight: "100%",
                color: "rgb(131,131,131)",
              }}>Respond automatically; flag uncertain or sensitive message</span>
            </div>
            <span style={{
              position: "absolute",
              left: 52,
              ...
              color: "rgb(131,131,131)",
            }}>Control the extent of Autonomy you agent has when engaging with followers </span>
          </div>
        </div>
      </div>
      <div style={{
...
export default AccountSettingsWorkspaceSettings15;
