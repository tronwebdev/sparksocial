// figma node: 1044:8953 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings17(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 1195,
          borderRadius: 30,
          background: "linear-gradient(154.598deg, rgba(245,107,255,0.2) 2.77%, rgba(255,255,255,0) 67.33%), linear-gradient(207.147deg, rgba(108,232,255,0.3) 2.68%, rgba(255,255,255,0) 71.66%), linear-gradient(rgb(247,247,247),rgb(247,247,247))",
        }} />
        <span style={{
          position: "absolute",
          left: 138,
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                width: 692,
                height: 902,
                clipPath: "inset(0px 0px 0px 0px round 41.977px)",
              }}>
                <svg width={692} height={902} viewBox="0 0 692 902" fill="none" style={{
                  position: "absolute",
                  left: 0,
                  top: 0,
                  width: 692,
                  ...
                  <path d={"M 0 41.981 C 0 18.798 18.794 0.004 41.977 0.004 L 311.454 0.004 L 347.274 0 L 382.091 0.004 L 650.023 0.003 C 673.206 0.003 692 18.797 692 41.981 L 692 860.023 C 692 883.206 673.206 902 650.023 902 L 42.1 902 C 18.869 902 0.055 883.132 0.123 859.901 L 1.313 450.771 L 0 330.073 L 0 174.657 L 0 41.981 Z"} fill="currentColor" fillRule="nonzero" />
                </svg>
                <div style={{
                  position: "absolute",
                  left: 260.295,
                  ...
                  <div style={{
                    ...
                    width: 171.654,
                    height: 106.634,
                    borderRadius: 14.502911567687988,
                    background: "linear-gradient(234.050deg, rgba(108,232,255,0.4) 10.27%, rgba(163,65,255,0.4) 91.76%)",
                    boxShadow: "inset 0 0 0 0.433px rgb(0,0,0)",
                  }} />
                  <div style={{
                    position: "absolute",
                    left: 27.379,
                    ...
                    backdropFilter: "blur(38.292px)",
                    boxShadow: "inset 0px 0px 11.600px -2.320px rgb(233,239,245)",
                  }} />
                  <div className="fig-asset-f859e5b8da73899b-4cef036d" style={{
                    position: "absolute",
                    left: 63.404,
                    top: 16.57,
                    width: 44.581,
                  ...
                  <div className="fig-asset-917118fb96434771-3ed25be0" style={{
                    position: "absolute",
                    left: 106.633,
                    top: 7.204,
                    width: 37.466,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <svg width={8.035} height={16.069} viewBox="0 0 8.035 16.069" fill="none" style={{
                    ...
                    left: 0,
                    top: 0,
                    transform: "matrix(-1,0,0,1,8.035,2.766)",
                    transformOrigin: "0 0",
                    width: 8.035,
                    height: 16.069,
                    borderRadius: 0.8457431197166443,
            ...
            <span style={{
              ...
              color: "rgb(0,0,0)",
            }}>How should your Agent sound?</span>
            <div style={{
              position: "absolute",
              left: 49,
              top: 151,
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  lineHeight: "100%",
                  color: "rgb(12,12,12)",
                }}>Use my brand voice (recommended)</span>
              </div>
              <div style={{
                position: "absolute",
                left: 12,
                ...
                <span style={{
                  ...
                  lineHeight: "100%",
                  color: "rgb(12,12,12)",
                }}> Customize engagement voice</span>
              </div>
            </div>
            <div style={{
              position: "absolute",
              ...
              <div style={{
                ...
                width: 566,
                height: 194,
                borderRadius: 19.13793182373047,
                backgroundColor: "rgba(131,131,131,0.04)",
                boxShadow: "inset 0 0 0 1px rgba(12,12,12,0.1)",
              }} />
              <div style={{
                position: "absolute",
            ...
            <span style={{
              ...
              color: "rgb(131,131,131)",
            }}>Replies will follow your brand voice.</span>
          </div>
        </div>
      </div>
      <div style={{
...
export default AccountSettingsWorkspaceSettings17;
