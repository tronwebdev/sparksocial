// figma node: 1044:5831 Account Settings (Workspace Settings)
export function AccountSettingsWorkspaceSettings2(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width={12.764} height={12.764} viewBox="0 0 12.764 12.764" fill="none" style={{
            position: "absolute",
            left: 197,
            top: 11,
            width: 12.764,
            ...
            <path d={"M 1.567 0.256 C 1.396 0.09 1.165 -0.002 0.926 0 C 0.687 0.002 0.458 0.098 0.289 0.267 C 0.12 0.436 0.025 0.665 0.022 0.904 C 0.02 1.143 0.112 1.373 0.278 1.545 L 5.104 6.371 L 0.278 11.196 C 0.191 11.28 0.122 11.381 0.074 11.492 C 0.026 11.603 0.001 11.723 0 11.844 C -0.001 11.965 0.022 12.085 0.068 12.197 C 0.114 12.309 0.181 12.411 0.267 12.497 C 0.353 12.582 0.454 12.65 0.566 12.696 C 0.679 12.742 0.799 12.765 0.92 12.764 C 1.041 12.763 1.16 12.737 1.272 12.69 C 1.383 12.642 1.483 12.572 1.567 12.485 L 6.393 7.66 L 11.219 12.485 C 11.391 12.651 11.621 12.743 11.86 12.741 C 12.099 12.739 12.328 12.643 12.497 12.474 C 12.666 12.305 12.762 12.077 12.764 11.837 C 12.766 11.598 12.674 11.368 12.508 11.196 L 7.682 6.371 L 12.508 1.545 C 12.674 1.373 12.766 1.143 12.764 0.904 C 12.762 0.665 12.666 0.436 12.497 0.267 C 12.328 0.098 12.099 0.002 11.86 0 C 11.621 -0.002 11.391 0.09 11.219 0.256 L 6.393 5.081 L 1.567 0.256 Z"} fill="currentColor" fillRule="evenodd" />
          </svg>
          <span style={{
            position: "absolute",
            left: 73,
          ...
          <div style={{
            ...
            <div style={{
              ...
              width: 46.968,
              height: 46.968,
              borderRadius: 92.15821838378906,
              backgroundColor: "rgb(248,248,248)",
              boxShadow: "inset 0 0 0 1.188px rgba(120,120,120,0.28)",
            }} />
            <div className="fig-asset-996b86b781440304-2d24ee17" style={{
              position: "absolute",
              left: 0,
              top: 0,
              width: 46.968,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div className="fig-asset-75744a74f30bbd3d-1e3817e5" style={{
              position: "absolute",
              left: 0,
              top: 0,
              width: 46.968,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            width: 129.511,
            height: 103.187,
            borderRadius: 10.529309272766113,
            backgroundColor: "rgb(255,255,255)",
            boxShadow: "inset 0 0 0 1.053px rgba(12,12,12,0.1)",
          }} />
          <span style={{
            position: "absolute",
            left: 30.535,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            fontFamily: "Onest, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
            fontWeight: 600,
            fontSize: 13.688102722167969,
            whiteSpace: "nowrap",
            lineHeight: "100%",
            color: "rgb(0,0,0)",
          }}>Google Business</span>
          <div className="fig-asset-af1c42c0de0849d2" style={{
            position: "absolute",
            left: 43.563,
            top: 17.242,
            width: 42.117,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="fig-asset-f2d5d281477a36bd-89471030" style={{
            position: "absolute",
            left: 41.457,
            top: 15.135,
            width: 46.329,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="fig-asset-649a98bc5482f9c0-35c812af" style={{
            position: "absolute",
            left: 39.351,
            top: 13.027,
            width: 50.541,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="fig-asset-04ebef6319dd43bc-f0f08d97" style={{
            position: "absolute",
            left: 41.983,
            top: 15.662,
            width: 45.276,
      ...
      <div style={{
        ...
        <div className="fig-asset-24a53206509fbcbd-64508d58" style={{
          position: "absolute",
          left: 44.089,
          top: 17.766,
          width: 41.064,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="fig-asset-57863ca26e1e0547-49f8381a" style={{
            position: "absolute",
            left: 42.51,
            top: 19.346,
            width: 44.223,
      ...
      <div style={{
        ...
        <div className="fig-asset-f7f4661f6c90f6ce" style={{
          position: "absolute",
          left: 43.919,
          top: 17.594,
          width: 41.406,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="fig-asset-b0f72847abd9b943-e4715096" style={{
            position: "absolute",
            left: 42.51,
            top: 16.186,
            width: 44.223,
      ...
      <span style={{
        ...
        color: "rgb(131,131,131)",
      }}>Connect your social media accounts to enhance your online presence.</span>
      <span style={{
        position: "absolute",
        left: 368,
        top: 167,
      ...
      <div style={{
        ...
        <div style={{
          ...
          left: 0,
          top: 0,
          transform: "matrix(-1,0,0,1,275,182)",
          transformOrigin: "0 0",
          width: 266,
          height: 50,
          borderRadius: 10,
...
export default AccountSettingsWorkspaceSettings2;
